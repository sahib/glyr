...
Please note: The Api won't be stable before version 0.9
...
The name probably (I actually don't know for sure, as my memory seems to have holes :-)) derives 
from the german word 'klirrn' which describes the sound of breaking dishes on the ground pretty well.
As free software starts often with a 'g', and I heard the song "Tanzwut - Im Rausch", which has the word 'klirrn'
in it, while thinking of a name I chose it. The 'k' was replaced by a 'g' (ofcourse) and the 'n' was removed in favour
of ease of pronouncing. 

It is pronounced exactly like breaking dishes btw. (don't do strange things in your kitchen now :-))
...
You also might consider a small (I'm already motivated by 1 Cent <img src="http://www.blendpolis.de/images/smilies/icon_wink.gif"/>) donation if you use any of my software in a commercial environement:<a class="FlattrButton" style="display:none;" rev="flattr;button:compact;" href="https://github.com/sahib/glyr"></a>
